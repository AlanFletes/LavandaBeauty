...
<div style="margin-left:30%; margin-right:30%; margin-top: -9%">
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                <td>Descripción:</td>
                <td><input id="descripcion" type="text"></td>
            </tr>
            <tr>
                <td>Categoria:</td>
                <td><input id="categoria" type="text"></td>
            </tr>
            <tr>
                <td>Precio:</td>
                <td><input id="precio" type="text"></input></td>
            </tr>
            <tr>
                <td>Imagen:</td>
    ...
    <tr>
        <td />
        <td><input id="boton" type="button" value="Subir"></td>
    </tr>
    </table>
</div>
</div>
...
<script type="text/javascript" src="{{ asset('js/filetobase64.js')}}"></script>
