...
<div >
    ...
    <li class="breadcrumb-item active" style="font-family: Tw Cen MT; font-size: 17px; text-decoration: none; color:#9669BB"><b><a href="Ayuda" style="text-decoration: none;color:#9669BB">Ayuda</a></b></li>
  </ol>
</div>
            ...
            <div class="menu-wrap" style="background-color: #CE98FC">
				...
				<h1 style="text-align:center; margin-top:-10%;">Ayuda</h1>
                <article class="container">
				La funcion principal de este sitio es el de proveer productos de calidad, los cuales pueden ser encontrados en la sección del menú por categorías, entre estas se encuentran <a href="Productos"> Cuidado de la piel </a>, <a href="Productos2">Maquillaje</a> y <a href="Productos3">Brochas</a>. <br/>
				<center>Próximamente se añadirán productos y categorías nuevas.</center><br/>
				Dentro de cada categoría, se puede visualizar el producto o bien, buscarlo mediante un nombre haciendo uso de la barra superior de búsqueda.				
                </article>
				<br/>
            <footer id="Contact">
  <div class="container">
