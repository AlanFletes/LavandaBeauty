...
//]]></script>
  <div >
    ...
    <li class="breadcrumb-item active" style="font-family: Tw Cen MT; font-size: 17px; text-decoration: none; color:#9669BB"><b><a href="Productos3" style="text-decoration: none;color:#9669BB">Producto</a></b></li>
    <li class="breadcrumb-item active" aria-current="page" id="current">Cuidado de la piel</li>
  </ol>
</div>
<!-- Boton menu-->
                          ...
                          <div class="aa-product-view-slider">                                
                            <div class="simpleLens-gallery-container" id="demo-1">
                              <div class="simpleLens-container">
                                <figure class="magarea" id="magarea">
                                  <div class="simpleLens-big-image-container" id="sldimage">
                                      
                                  </div>
                                </figure>
                              </div>
                              <div class="simpleLens-thumbnails-container" id="slcontainer">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="aa-product-view-content">
                            ...
                            <div class="aa-price-block">
                              <span id="prodprec" class="aa-product-view-price"></span>
