...
<div >
    ...
    <li class="breadcrumb-item active" style="font-family: Tw Cen MT; font-size: 17px; text-decoration: none; color:#9669BB"><b><a href="Productos3" style="text-decoration: none;color:#9669BB">Mapa del sitio</a></b></li>
  </ol>
</div>
</div>
            ...
            <div class="menu-wrap" style="background-color: #CE98FC">
                ...
                <div style="text-align:center; margin-top:-10%;">
					...
					<ul>
						...
						<li><a href="Mapa">Mapa del sitio</a></li>
						<li><a href="Ayuda">Página de ayuda</a></li>
						<li><a href="Unirse">Registrarse</a></li>
						<li><a href="{{ asset('docs/catalogo.pdf')}}">Descargar catálogo</a></li>
						<li>Categorías de productos<ul>
							<li><a href="Productos">Cuidado de la piel</a></li>
							<li><a href="Productos2">Maquillaje</a></li>
							<li><a href="Productos3">Brochas</a></li>
						</ul></li>
